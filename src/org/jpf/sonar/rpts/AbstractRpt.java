...
public abstract class AbstractRpt
{
	...
	String strEndDate = DateTimeUtil.GetDay("yyyy-MM-dd", -1);
	String strBeginDate = DateTimeUtil.GetDay("yyyy-MM-dd", -7);
	...
	private void MakeWeekRpt(String strPrjName, int iType, String strMailCC)
	{
		...
		try
		{
			...
			String strDevHtmlString = FileUtil.GetFileTxt(GetTemplateName());
